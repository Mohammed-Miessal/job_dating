        ...
        <tbody>
            @foreach ($announcements as $announcement)
                <tr class="border-b dark:border-gray-700">
                    <td class="px-4 py-3 text-center">{{ $announcement->id }}</td>

                    <td class="px-4 py-3 text-center">
                        @if ($announcement->image)
                            <div class="flex flex-col justify-center items-center">
                                <img src="{{ asset('storage/announcement_images/' . $announcement->image) }}"
                                    alt="Announcement Image" class="w-auto h-16">
                            </div>
                        @else
                            No Image
                        @endif
                    </td>
                    <td class="px-4 py-3 text-center">{{ $announcement->title }}</td>
                    <td class="px-4 py-3 text-center">{{ $announcement->description }}</td>
                    <td class="px-4 py-3 text-center">{{ $announcement->content }}</td>
