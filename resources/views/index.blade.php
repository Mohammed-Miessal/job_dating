    ...
    <div class="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col lg:flex-row gap-10 lg:gap-12">
      ...
      <div class="relative flex flex-col items-center text-center lg:text-left lg:py-7 xl:py-8 
        ...
        <h1 class="text-3xl leading-tight sm:text-4xl md:text-5xl xl:text-6xl
          ...
          Unlock Your Professional Potential: Join the Job Dating <span class="text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 from-20% via-blue-600 via-30% to-green-600">Revolution!</span>

        </h1>

        <div class="mt-10  w-full flex max-w-md mx-auto lg:mx-0">
          <div class="flex sm:flex-row flex-col gap-5 w-full">
            <form action="#" class="py-1 pl-6 w-full pr-1 flex gap-3 items-center text-gray-600 shadow-lg shadow-gray-200/20
              ...
              <input type="email" name="" id="" placeholder="youcode@gmail.com" class="w-full py-3 outline-none bg-transparent">
    ...
    <div class="mb-10  divide-y">
      ...
      <section>
        <div class="mb-12 text-center">
          <h2 class="text-dark mb-3.5 text-4xl font-bold  font-mulish text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 from-20% via-blue-600 via-30% to-green-600">
            Announcements
          </h2>
          <p>
        ...
        <div class="grid grid-cols-1 gap-12 lg:gap-24 lg:grid-cols-2">
          ...
          <div class="sm:flex lg:items-start group">
            <div class="flex-shrink-0 mb-4 sm:mb-0 sm:mr-4">
              ...
              <img class="w-full rounded-md sm:h-32 sm:w-32 object-cover" src="{{ asset('images/sincerely-media-vcF5y2Edm6A-unsplash.jpg') }}" alt="text">
            </div>
            <div>
              <span class="text-sm text-gray-500">August 20.20.21</span>
              <p class="mt-3 text-lg font-medium leading-6">
                <a href="singlepage" class="text-xl text-gray-800 hover:text-gray-500">B2B Branding: 5 tips to go from boring to extraordinary </a>
              </p>
          ...
          <div class="sm:flex lg:items-start group">
            <div class="flex-shrink-0 mb-4 sm:mb-0 sm:mr-4">
              <img class="w-full rounded-md sm:h-32 sm:w-32 object-cover" src="{{ asset('images/the-jopwell-collection-u5pAYGDWD54-unsplash.jpg') }}" alt="text">
            </div>
            <div>
              <span class="text-sm text-gray-500">August 20.20.21</span>
              <p class="mt-3 text-lg font-medium leading-6">
          ...
          <div class="sm:flex lg:items-start group">
            <div class="flex-shrink-0 mb-4 sm:mb-0 sm:mr-4">
              <img class="w-full rounded-md sm:h-32 sm:w-32 object-cover" src="{{ asset('images/uk-black-tech-uZyE3w7khzw-unsplash.jpg') }}" alt="text">
            </div>
            <div>
              <span class="text-sm text-gray-500">August 20.20.21</span>
              <p class="mt-3 text-lg font-medium leading-6">
          ...
          <div class="sm:flex lg:items-start group">
            <div class="flex-shrink-0 mb-4 sm:mb-0 sm:mr-4">
              <img class="w-full rounded-md sm:h-32 sm:w-32 object-cover" src="{{ asset('images/campaign-creators-qCi_MzVODoU-unsplash.jpg') }}" alt="text">
            </div>
            <div>
              <span class="text-sm text-gray-500">August 20.20.21</span>
              <p class="mt-3 text-lg font-medium leading-6">
