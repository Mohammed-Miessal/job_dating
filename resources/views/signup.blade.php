  ...
  <div class="min-h-screen  text-gray-900 flex justify-center">
    <div class="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          ...
          <div class="w-full flex-1 mt-8">
            ...
            <div class="flex min-h-full flex-col justify-center px-6  lg:px-8">
              <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <h2 class="font-lora  text-center text-2xl  leading-9 tracking-tight text-gray-900">
                  Sign up
                </h2>
              </div>
      ...
      <div class="flex-1  text-center hidden lg:flex">
        <div class="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat" style="background-image: url('{{ asset('images/charlesdeluvio-rRWiVQzLm7k-unsplash.jpg') }}');"></div>
      </div>
    </div>
  </div>
</body>
